...
import { chatWithNourishBot } from '../../services/ai/geminiService';
...
const NourishBot = () => {
    ...
    const handleSend = async () => {
        ...
        const botMsg = { id: (Date.now() + 1).toString(), role: 'model', text: responseText || 'Sorry, I missed that.', timestamp: Date.now() };
